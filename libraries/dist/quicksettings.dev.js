...
(function () {
  ...
  var QuickSettings = {
     ...
     */
    setValuesFromJSON: function setValuesFromJSON(json) {
     ...
     */
    saveInLocalStorage: function saveInLocalStorage(name) {
     ...
     */
    clearLocalStorage: function clearLocalStorage(name) {
      localStorage.removeItem(name);
      return this;
    },
    _saveInLocalStorage: function _saveInLocalStorage(name) {
      localStorage.setItem(name, this.getValuesAsJSON(true));
    },
    _readFromLocalStorage: function _readFromLocalStorage(name) {
    ...
    _callGCH: function _callGCH(title) {
     ...
     * @returns {module:QuickSettings}
     */
    setKey: function setKey(_char) {
      this._keyCode = _char.toUpperCase().charCodeAt(0);
    ...
    ////////////////////////////////////////////////////////////////////////////////
    getValue: function getValue(title) {
      return this._controls[title].getValue();
    },
    setValue: function setValue(title, value) {
     ...
     * @returns {module:QuickSettings}
     */
    addImage: function addImage(title, imageURL, callback) {
      var container = this._createContainer(),
          label = createLabel("<b>" + title + "</b>", container);
     ...
     * @returns {module:QuickSettings}
     */
    setProgressMax: function setProgressMax(title, max) {
      var control = this._controls[title];
      control.max = max;
    ...
    _addText: function _addText(type, title, text, callback) {
      var container = this._createContainer();
